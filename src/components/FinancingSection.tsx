      ...
      <div className="max-w-[1720px] w-full mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-slate-600 font-medium text-base sm:text-lg leading-relaxed max-w-lg">
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm sm:text-base font-bold text-[#0B1220]">Flexible financing options</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm sm:text-base font-bold text-[#0B1220]">Fast & easy online approval</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm sm:text-base font-bold text-[#0B1220]">No hidden fees or unexpected surprise charges</span>
              </div>
            </div>
            ...
            <div className="pt-3">
              <button
                ...
                className="inline-flex items-center gap-2.5 px-7 py-4 rounded-xl bg-[#1D61E7] hover:bg-[#1552C6] text-white font-bold text-base shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer transform active:scale-98"
              >
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200 aspect-[4/3] w-full">
              ...
              <div className="absolute bottom-6 left-6 right-6 sm:left-auto sm:right-6 sm:max-w-xs bg-white/95 backdrop-blur-md rounded-2xl p-5 shadow-2xl border border-slate-100">
                <div className="flex items-center gap-3 border-b border-slate-100 pb-3 mb-3">
                  ...
                  <div>
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-wider block">Monthly Payments</span>
                    <span className="text-sm font-extrabold text-[#0B1220]">As Low As</span>
                  </div>
                </div>

                <div className="flex items-baseline gap-1">
                  <span className="text-3xl sm:text-4xl font-black text-[#1D61E7]">$129</span>
