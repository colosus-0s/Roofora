      ...
      <div className="max-w-[1720px] w-full mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#F8FAFC] rounded-2xl p-6 border border-slate-200/80 shadow-2xs space-y-3 max-w-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-1.5 text-lg font-black text-[#0B1220]">
                    <span>4.9</span>
          ...
          <div className="lg:col-span-8">
            <div className="bg-[#F8FAFC] rounded-2xl p-8 sm:p-10 border border-slate-200/80 shadow-xl relative overflow-hidden flex flex-col justify-between space-y-6">
              
              <div className="flex items-start justify-between">
                <Quote className="w-12 h-12 text-[#1D61E7]/20" />
              ...
              {/* Quote Text */}
              <blockquote className="text-lg sm:text-xl lg:text-2xl font-bold text-[#0B1220] leading-relaxed italic">
                "{activeItem.quote}"
              </blockquote>
              ...
              <div className="pt-4 border-t border-slate-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3.5">
                  ...
                  />
                  <div>
                    <div className="text-base font-extrabold text-[#0B1220]">{activeItem.name}</div>
                    <div className="text-xs text-slate-500 font-semibold">{activeItem.location} • <span className="text-[#1D61E7]">{activeItem.service}</span></div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2.5 rounded-xl bg-white border border-slate-200 text-[#0B1220] hover:text-[#1D61E7] hover:bg-slate-50 shadow-2xs transition-all cursor-pointer"
